...
from utils.helpers import get_ohlcv_file, get_timeframe, resample_null_bars
...
with open(configuration_file) as f:
  ...
  raw_bars = open_convert_csv_files(exchange_name, symbol, timeframe, start, end, bar_type=bar_type, tz=False)

  bars = resample_null_bars(raw_bars)
  raw_features = {}
  if included_correlation_symbols:
    for s in included_correlation_symbols:
      raw_features[s] = open_convert_csv_files(exchange_name, s, timeframe, start, end, bar_type=bar_type, tz=False)
