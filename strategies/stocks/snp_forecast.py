...
from ..utils import create_lagged_series
...
class SPYDailyForecastStrategy(Strategy):
    ...
    def create_symbol_forecast_model(self):
        ...
        snpret = create_lagged_series(
            self.instruments[0], self.model_start_date,
        ...
        if event.type == 'MARKET':
            ...
            if self.bar_index > 5:
                lags = self.bars.get_latest_bars_values(
                    self.instruments[0], "returns", N=3
                )
...
if __name__ == "__main__":
    ...
    backtest = Backtest(
        csv_dir, instruments, initial_capital, heartbeat,
