...
class OLSMeanReversionStrategy(Strategy):
    ...
    def __init__(
        ...
        self.exchange = configuration.exchanges[0]
        self.events = events
    ...
    def calculate_signals_for_pairs(self):
        ...
        y = self.data.get_latest_bars_values(self.pair[0], "close", N=self.ols_window)
        x = self.data.get_latest_bars_values(self.pair[1], "close", N=self.ols_window)
